    ...
    <div className={`relative flex ${isResizing ? 'select-none cursor-col-resize' : ''}`}>
      ...
      >
        ...
        <Tabs defaultValue="roadmap" className="flex flex-col flex-1 overflow-hidden">
          ...
          {/* Roadmap Tab */}
          <TabsContent value="roadmap" className="flex-1 overflow-hidden min-h-0">
          ...
          {/* Resources Tab */}
          <TabsContent value="resources" className="flex-1 overflow-hidden min-h-0">
            <ScrollArea className="h-full">
          ...
          <TabsContent value="chat" className="flex-1 overflow-hidden min-h-0">
            <ScrollArea className="h-full">
              <div className="px-4 pb-4 flex flex-col pt-2">
