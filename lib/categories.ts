    ...
    topics: [
      {
        ...
        icon: '🌐',
        description: 'Secure networks from unauthorized access and attacks',
        courseCount: 8,
      },
      {
        id: 'ethical-hacking',
      ...
      },
      {
        ...
        name: 'Cryptography',
        icon: '🔑',
        description: 'Study encryption, decryption, and secure communication',
        courseCount: 6,
      },
      {
        ...
        icon: '🚨',
        description: 'Manage and respond to security breaches and attacks',
        courseCount: 5,
      },
      {
        id: 'cloud-security',
        name: 'Cloud Security',
        icon: '☁️',
        description: 'Secure data and infrastructure in cloud environments',
        courseCount: 6,
      },
      {
        id: 'code-analysis',
        name: 'Code Analysis',
        icon: '🔍',
        description: 'Analyze source code for security flaws and quality issues',
        courseCount: 4,
      },
      {
        id: 'web-security-engineer',
        name: 'Web Security Engineer',
        icon: '🏗️',
        description: 'Build and maintain secure web architectures',
        courseCount: 5,
      },
      {
        ...
        icon: '📦',
        description: 'Ensure security throughout the product lifecycle',
        courseCount: 5,
      },
      {
        ...
        icon: '🎯',
        description: 'Perform authorized simulated attacks to test security',
        courseCount: 8,
      },
    ],
  },
    ...
    topics: [
      {
        ...
        icon: '🧩',
        description: 'Common solutions to recurring software design problems',
        courseCount: 12,
      },
      {
        id: 'microservices',
        ...
        icon: '📦',
        description: 'Build systems as a collection of loosely coupled services',
        courseCount: 9,
      },
      {
        id: 'system-design',
        name: 'System Design',
        icon: '📐',
        description: 'Design large-scale distributed systems and infrastructures',
        courseCount: 15,
      },
      {
        ...
        icon: '🧼',
        description: 'Maintain separation of concerns and testability',
        courseCount: 7,
      },
      {
        id: 'cloud-native',
        ...
        icon: '☁️',
        description: 'Leverage cloud computing models for scalability',
        courseCount: 8,
      },
      {
        id: 'ddd',
        ...
        icon: '🗺️',
        description: 'Align software design with complex business domains',
        courseCount: 6,
      },
      {
        id: 'api-design',
        name: 'API Design',
        icon: '🔌',
        description: 'Design consistent, secure, and developer-friendly APIs',
        courseCount: 10,
      },
      {
        id: 'event-driven',
